        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoModel = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleSalary = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Magazines_Autos_AutoId",
                        column: x => x.AutoId,
                        principalTable: "Autos",
                        principalColumn: "AutoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Magazines_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Magazines_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Magazines_AutoId",
                table: "Magazines",
                column: "AutoId");

            migrationBuilder.CreateIndex(
                name: "IX_Magazines_ClientId",
                table: "Magazines",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Magazines_EmployeeId",
                table: "Magazines",
                column: "EmployeeId");
        }
